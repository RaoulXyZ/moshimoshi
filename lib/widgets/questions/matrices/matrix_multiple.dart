...
class MatrixMultiple extends StatefulWidget {
  ...
  @override
  _MatrixMultipleState createState() => _MatrixMultipleState();
}

class _MatrixMultipleState extends State<MatrixMultiple> {
  @override
  void initState() {
    super.initState();
  }
