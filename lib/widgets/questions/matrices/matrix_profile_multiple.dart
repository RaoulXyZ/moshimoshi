...
class MatrixProfileMultiple extends StatefulWidget {
  ...
  @override
  _MatrixProfileMultipleState createState() => _MatrixProfileMultipleState();
}

class _MatrixProfileMultipleState extends State<MatrixProfileMultiple> {
  @override
  void initState() {
    super.initState();
  }
...
class _RisposteState extends State<Risposte> {
  ...
  void initState() {
    ...
    _selectedChoices = answers.getAnswer(widget.surveyID, "${qid}_$cid") ?? [];
  }
                    ...
                    return Padding(
                      ...
                      child: TextButton(
                        ...
                        onPressed: widget.disabled
                            ? null
                            : () {
                                if (_selectedChoices.contains(answer.key)) {
                                  _selectedChoices.remove(answer.key);
                                } else {
                                  _selectedChoices.add(answer.key);
                                }
                        ...
                        child: Ink(
                          decoration: BoxDecoration(
                            color: _selectedChoices.contains(answer.key)
