...
class MatrixSingle extends StatefulWidget {
  ...
  @override
  _MatrixSingleState createState() => _MatrixSingleState();
}

class _MatrixSingleState extends State<MatrixSingle> {
  @override
  void initState() {
    super.initState();
  }
