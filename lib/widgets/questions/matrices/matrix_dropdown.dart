...
class MatrixDropdown extends StatefulWidget {
  ...
  @override
  _MatrixDropdownState createState() => _MatrixDropdownState();
}

class _MatrixDropdownState extends State<MatrixDropdown> {
  @override
  void initState() {
    super.initState();
  }
